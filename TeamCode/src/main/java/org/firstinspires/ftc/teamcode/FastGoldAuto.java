...
public class FastGoldAuto extends OpMode{
    ...
    private int centerArmPosition = -1600+3500;
    private int crater = 30+4800;
    private int hover = -200+4800;
    private int lander = -3200+4800;
    ...
    public void loop() {
        ...
        if (firstRun == true) {
            ...
            if (stageCounter == 0) {
                driveAtSpeed(-19, DRIVE_SPEED_FAST);        // drive(-19);
            }
            if (stageCounter == 1) {
                stopAndResetEncoder();
            }
            if (stageCounter == 2) {
                driveAtSpeed(-2, DRIVE_SPEED_SLOW);         // driveSlow(-2);
            }
            if (stageCounter == 3) {
                stopAndResetEncoder();
            }
            ...
            if (path == 1) {
                ...
                if (stageCounter == 5) {
                    driveAtSpeed(-40, DRIVE_SPEED_FAST);        // drive(-42);
                }
                if (stageCounter == 6) {
                    stopAndResetEncoder();
                }
                ...
                if (stageCounter == 9) {
                    driveAtSpeed(-15, DRIVE_SPEED_FAST);        // drive(-60);
                }
                if (stageCounter == 10) {
                    stopAndResetEncoder();
                }
                ...
                if (stageCounter == 13) {
                    driveAtSpeed(-40, DRIVE_SPEED_FAST);        // drive(-60);
                }
                if (stageCounter == 14) {
                    stopAndResetEncoder();
                }
            ...
            if (path == 2) {
                // second route
                if (stageCounter == 13) {
                    driveAtSpeed(-10, DRIVE_SPEED_FAST);            // drive(-16);
                }
                if (stageCounter == 14) {
                    stopAndResetEncoder();
                }
                if (stageCounter == 15) {
                    driveAtSpeed(21, DRIVE_SPEED_FAST);             // drive(27);
                }
                if (stageCounter == 16) {
                    stopAndResetEncoder();
                }
                ...
                if (stageCounter == 19) {
                    driveAtSpeed(42, DRIVE_SPEED_FAST);             // drive(42);
                }
                if (stageCounter == 20) {
                    stopAndResetEncoder();
                }
            ...
            if (path == 3) {
                ...
                if (stageCounter == 17) {
                    driveAtSpeed(-34, DRIVE_SPEED_FAST);
                }
                if (stageCounter == 18) {
                    stopAndResetEncoder();
                }
                if (stageCounter == 19) {
                    driveAtSpeed(2, DRIVE_SPEED_FAST);              // drive(2);
                }
                if (stageCounter == 20) {
                    stopAndResetEncoder();
                }
                ...
                if (stageCounter == 23) {
                    driveAtSpeed(28, DRIVE_SPEED_FAST);             // drive(30);
                }
                if (stageCounter == 24) {
                    MarkerServo.setPosition(.7);
                    stopAndResetEncoder();
                ...
                if (stageCounter == 25) {
                    driveAtSpeed(-45, DRIVE_SPEED_FAST);            // drive(-60);
                }
                if (stageCounter == 26) {
                    shoulderPosition(hover);
                    MarkerServo.setPosition(.1);
