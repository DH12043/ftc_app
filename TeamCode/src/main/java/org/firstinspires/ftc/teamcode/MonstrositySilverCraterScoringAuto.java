...
//            HangingMotor.setPower(-1);
            ...
            //drive toward sample
            if (stageCounter == 2) {
                driveAtSpeed(-11, DRIVE_SPEED_SLOW); //-10
            }
            if (stageCounter == 3) {
                stopAndResetEncoder();
            }
            ...
            if (path == 1) {
                ...
                if (currentTime - startTime < 28) {
                    ...
                    if (stageCounter == 13) {
                        driveAndArm(-10, DRIVE_SPEED_SLOW, crater);
                    }
                    if (stageCounter == 14) {
                        stopAndResetEncoder();
                    }
                    ...
                    if (stageCounter == 17) {
                        SorterServo.setPosition(center);
                        driveAndArm(-8, DRIVE_SPEED_SLOW, lander);
                    }
                    if (stageCounter == 18) {
                        stopAndResetEncoder();
                    }
                    ...
                    if (stageCounter == 26) {
                        driveAndArm(-9, DRIVE_SPEED_SLOW, crater);
                    ...
                    if (stageCounter == 30) {
                        SorterServo.setPosition(center);
                        driveAndArm(-12, DRIVE_SPEED_FAST, lander);
                    }
                    if (stageCounter == 31) {
                        stopAndResetEncoder();
                    }
                    ...
                    if (stageCounter == 40) {
                        driveAtSpeed(13, DRIVE_SPEED_SLOW);
                    }
                    if (stageCounter == 41) {
                        stopAndResetEncoder();
                    }
    ...
    private void driveAndArm(int distance, double power, int position) {
        ...
        if (FRdriveCorrect && FLdriveCorrect && BRdriveCorrect && BLdriveCorrect && (encoderPosition > position-10 && encoderPosition < position+10)) {
            stageCounter++;
        }
    }
    ...
    private void checkSampleSensors() {
        ...
        if (75 * (CenterSampleColors1.red + CenterSampleColors1.green - 2 * CenterSampleColors1.blue) >= 25) {
            centerIsGold = true;
        }
        ...
        if (75 * (CenterSampleColors2.red + CenterSampleColors2.green - 2 * CenterSampleColors2.blue) >= 25) {
            centerIsGold = true;
        }
        ...
        if (75 * (CenterSampleColors3.red + CenterSampleColors3.green - 2 * CenterSampleColors3.blue) >= 25) {
            centerIsGold = true;
        }
        ...
        if (75 * (RightSampleColors1.red + RightSampleColors1.green - 2 * RightSampleColors1.blue) >= 25) {
            rightIsGold = true;
        }
        ...
        if (75 * (RightSampleColors2.red + RightSampleColors2.green - 2 * RightSampleColors2.blue) >= 25) {
            rightIsGold = true;
        }
        ...
        if (75 * (RightSampleColors3.red + RightSampleColors3.green - 2 * RightSampleColors3.blue) >= 25) {
            rightIsGold = true;
        }
